...
namespace Fos.Owin
{
	...
	internal class FosAppBuilder2 : IAppBuilder
	{
		...
		public FosAppBuilder2(CancellationToken cancelToken, IServerLogger logger)
		{
			if (logger == null)
			{
		...
		/// <summary>
		/// FOS intercepts existing 'Use' calls and wraps them in the <see cref="FosAppBuilder2"/>.
		/// </summary>
		...
		{
			return new FosAppBuilder2(OnAppDisposing, _logger);
		}
